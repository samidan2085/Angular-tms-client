...
// ^^ two validators: the field is required AND mustmatch the pattern STU-1234
...
// "get backups()" is a TypeScript property accessor it looks like avariable but runs a function.
...
// markAllAsTouched() forces Angular to show validation errors onevery field.
